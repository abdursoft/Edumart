            ...
            $.ajax({
                ...
                success: (data) => {
                    ...
                    for (const key in data) {
                        ...
                        $('#subject_id').append(new Option(element.name, element.id, true, true)).trigger('change');
                    }
                }
            })
        })
        ...
        @if($assignment)
            ...
            $.ajax({
                ...
                success: (data) => {
                    ...
                    for (const key in data) {
                        const element = data[key];
                        const isSubject = element.id == '{{$assignment->subject_id}}' ? true : false;
                        $('#subject_id').append(new Option(element.name, element.id, isSubject, isSubject)).trigger('change');
                    }
                }
            })
        @endif
