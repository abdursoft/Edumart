                        ...
                        <ol class="dd-list">
                            @foreach ($nav as $key => $item)
                                <li class="dd-item" data-id="{{ $item['id'] }}" data-name="{{ $item['name'] }}"
                                    data-attribute="{{ $item['attribute'] }}" data-page="{{ $item['url'] ?? '' }}"
                                    data-url="{{ $item['url'] }}" data-target="{{ $item['target'] }}"
                                    data-visible="{{ $item['visible'] }}" data-new="{{ $key }}"
                                    data-owner-id="item-{{ $item['id'] }}" data-deleted="1">
                                    ...
                                    <span
                                        ...
                                        data-owner-id="{{ $item['id'] }}"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <span
                                        class="button-edit px-2 py-1 rounded absolute right-[5px] cursor-pointer hover:text-green-500"
                                            ...
                                            @foreach ($item['children'] as $key => $child)
                                                <li class="dd-item" data-id="{{ $child['id'] }}"
                                                    ...
                                                    <div class="dd-handle bg-gray-200 p-3 cursor-move">
                                                        {{ $child['name'] }}
                                                        ({{ $child['visible'] == 1 ? 'visible' : 'invisible' }})
                                                    </div>
                                                    <span
                                                        class="button-delete px-2 py-1 rounded absolute right-[40px] cursor-pointer hover:text-red-500"
                                                        data-owner-id="{{ $child['id'] }}"><svg
