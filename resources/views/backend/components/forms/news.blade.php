...
<form action="@if($notice){{ route('admin.information.news.update', $notice->id) }}@else{{ route('admin.information.news.add') }}@endif" method="POST">
    @csrf

    <x-fieldset title="News Information">
        ...
        :items="[
            ...
            ['label' => 'New', 'type' => 'button',
                ...
                'click' => 'window.location.href=`'.route('admin.information.news').'`']
