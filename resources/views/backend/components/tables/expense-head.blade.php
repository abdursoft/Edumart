...
<div class="w-full text-slate-800">
    <x-fieldset title="Expense heads">
        <!-- Card -->
...
@push('scripts')
    {{ loadDataTable('menuTable', 'Exam heads')}}
@endpush
