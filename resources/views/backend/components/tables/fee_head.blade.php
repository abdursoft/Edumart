                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center gap-1">
                                    ...
                                    class="py-1 px-2 hover:rounded-[15px] hover:shadow-md hover:bg-green-600 text-green-600 hover:text-white transition-all delay-10">
                                        {!! icons('edit') !!}
                                    </a>
                                    <a href="{{ route('admin.finance.fees.fee_heads.delete', $head->id) }}"
                                    class="py-1 px-2 hover:bg-red-600 text-red-600 hover:rounded-[15px] hover:shadow-md hover:text-white transition-all delay"
