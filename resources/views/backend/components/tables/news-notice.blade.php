...
<div class="w-full text-slate-800">
    <h2 class="text-xl md:text-2xl mt-5 font-semibold">Notice List</h2>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex items-center gap-3">
                                <a href="{{ route('admin.information.notice_board.edit', $notice->id) }}"
                                   class="py-1 px-4 rounded-[15px] shadow-md bg-green-600 text-white hover:bg-green-800 transition">
                                    Edit
                                </a>
                                <a href="{{ route('admin.information.notice_board.delete', $notice->id) }}"
