                    ...
                    <tr>
                        ...
                        <td>
                             <div class="flex items-center gap-1">
                                <a href="{{ route('page',$page->slug) }}" target="_blank" class="py-1 px-2 rounded-[15px] shadow-md hover:bg-gray-600 text-slate-600 hover:bg-gray-800 hover:text-white transition">{!! icons('view') !!}</a>
