    ...
    <div class="card my-5">
        <div class="w-full">
            ...
            <div class="">
                ...
                <ul class="px-4 mt-3 w-full grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
            ...
            <div class="w-full mt-[50px] px-4 text-center">
                <a href="{{ config('app.url') }}" class="bg-[#155A92] p-3 rounded-md text-white w-full text-center">
                    Go To HomePage
                </a>
            </div>
        </div>
