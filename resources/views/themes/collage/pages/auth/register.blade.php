        ...
        <div class="flex flex-col justify-center w-full h-screen dark:bg-gray-900 p-3 lg:flex-row">
            ...
            <div class="flex flex-col flex-1 w-full lg:w-1/2">
                ...
                <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
                    ...
                    <div>
                        <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5 hidden">
                            <button
                        ...
                        <div class="w-full flex items-center justify-center px-3 py-2 rounded-md text-yellow-600 font-semibold text-lg bg-slate-800">
