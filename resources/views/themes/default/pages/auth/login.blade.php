                    ...
                    <div class="shadow-md rounded-md bg-gray-100 dark:bg-gray-800 py-3 px-4">
                        ...
                        <form action="{{route('login.action')}}" autocomplete="off" id="loginForm" method="post">
                            ...
                            <div class="space-y-5">
                                ...
                                <div class="w-full grid grid-cols-1 md:grid-cols-2">
                                    <div x-data="{ checkboxToggle: false }">
                                        <label for="checkboxLabelOne"
                                            ...
                                            <div class="relative">
                                                <input type="checkbox" name="remember_me" id="checkboxLabelOne" class="sr-only"
                                    ...
                                    <div class="text-white text-right">
                                        <a class="text-gray-500 hover:text-teal-800" href="{{ route('password.request') }}">
                                ...
                                <div class="">
                                    <button
                                        class="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-slate-500 shadow-theme-xs hover:bg-slate-600">
                                        Sign in
                                    </button>
                                </div>
                            </div>
